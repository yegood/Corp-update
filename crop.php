...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
  ...
  $fileArr = explode('.',$src);
  $newsrc='./demo_files/'.md5(uniqid(microtime())) . '.' . $fileArr[1];
...
var_dump(imagejpeg($dst_r,null,$jpeg_quality));
*/
  exit;
}

// If not a POST request, display page below:onsubmit="return checkCoords();"
